...
import com.eco.androidtutorial.databinding.DialogSale30percentWeeklyBinding
import com.eco.androidtutorial.ui.LoadingState
import com.eco.androidtutorial.ui.TermAndPrivacyHelper
import kotlinx.coroutines.delay
import kotlinx.coroutines.launch

class Sale30PercentWeeklyDialogFragment : DialogFragment() {
    private var _binding: DialogSale30percentWeeklyBinding? = null
    private val binding get() = _binding!!

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?
    ): View {
        _binding = DialogSale30percentWeeklyBinding.inflate(inflater, container, false)
        return binding.root
    }
